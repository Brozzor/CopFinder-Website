...
<head>
    ...
    <title>
        CopFinder - Droplist Supreme <?= $dropItems[0]['season']; ?> <?= LANG_UTIL; ?>
    </title>
    ...
    <link rel="alternate" href="https://cop-finder.com/fr/droplist/week/<?= $dropItems[0]['season']; ?>" hreflang="fr" />
    <link rel="alternate" href="https://cop-finder.com/en/droplist/week/<?= $dropItems[0]['season']; ?>" hreflang="en" />
    <link rel="alternate" href="https://cop-finder.com/en/droplist/week/<?= $dropItems[0]['season']; ?>" hreflang="x-default" />
    ...
    <div class="section section-gray">
        <div class="container">
            <div class="main main-raised main-product" style="min-height: 370px;">
                <div id="page-data">
                    <h2 class="card-title text-center" id="product-name">Semaine <?= $dropItems[0]['week']; ?></h2>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <a href="droplist.php?season=<?= $dropItems[0]['season']; ?>"><button class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left"></i> retour</button></a>
                                <div class="row">
                                    <?php
                                    ...
                                    ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="card items-drop">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><?= strip_tags($row['description']); ?></p>
