...
define('TXT_PAY_ACCORDEON1_TITLE', 'Interface\'s'); 
...
define('TXT_PAY_COUPON_DESC', 'Nous vous donnons parfois des codes promotionnels de recudtions, suivez nos réseaux sociaux et restez a l\'affu de toute nos mises a jours de nos promotions et de nos informations.');
define('TXT_PAY_COUPON_ENTER', 'Entrer le code');
define('TXT_PAY_COUPON_HAVE', 'Vous avez un code ?');
...
define('TXT_PAY_SUCCESS', 'Votre paiement a été effectué et votre clé a été envoyée par mail. Si vous n\'avez rien reçu vérifiez vos spams , si après 1 heure vous n\'avez toujours rien reçu contactez le support dans notre onglet contact:');
